...
@section('grill')
<form action="/waschmaschine" method="POST">
            @csrf
        <div class="container" align="center">
    
        <div class="row" style="padding: 20px 0px 0px 0px">
            <div class="col-sm-12 col-md-12 col-lg-6">
            <h4>Tischtennisplatte</h4>
            <img src="./assets/productimages/tischtennis_platte.jpg" class="img-fluid" width="450px" alt="Responsive image">
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="product" value="tischtennisplatte"> 
            <!-- controls -->
