...
@section('grill')
<form action="/staender" method="POST">
            @csrf
        ...
        <div class="row" style="padding: 20px 0px 0px 0px">
            ...
            <h4>Wäscheständer</h4>
            <img src="./assets/productimages/ws.jpg" class="img-fluid" width="450px" alt="Responsive image">
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="product" value="staender"> 
            <!-- controls -->
