...
<form action="/bett" method="POST">
        ...
        <div class="row" style="padding: 20px 0px 0px 0px">
            ...
            <h4>Billardtisch</h4>
            <img src="./assets/productimages/pool_table.jpg" class="img-fluid" width="450px" alt="Responsive image">
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="product" value="pooltable"> 
            <!-- controls -->
