...
<form action="/couch" method="POST">
        ...
        <div class="row" style="padding: 20px 0px 0px 0px">
            ...
            <h4>Sofa</h4>
            <img src="./assets/productimages/couch.jpg" class="img-fluid" width="450px" alt="Responsive image">
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="product" value="couch"> 
            <!-- controls -->
