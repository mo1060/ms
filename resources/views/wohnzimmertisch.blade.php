...
<form action="/mixer" method="POST">
        ...
        <div class="row" style="padding: 20px 0px 0px 0px">
            ...
            <h4>Wohnzimmertisch</h4>
            <img src="./assets/productimages/couch_tisch.jpg" class="img-fluid" width="450px" alt="Responsive image">
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="product" value="wohnzimmertisch"> 
            <!-- controls -->
